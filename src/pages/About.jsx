          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-text-primary mb-10 leading-[1.1] uppercase">
                Product Designer with a strong foundation in visual and graphic design
              </h1>
              <p className="text-lg md:text-xl text-text-secondary font-medium leading-relaxed mb-6 max-w-xl">
                I started in graphic design, where I learned how to think about layout, hierarchy, and visual clarity. That foundation now shapes how I design digital products.
              </p>
              <p className="text-lg md:text-xl text-text-secondary font-medium leading-relaxed max-w-xl">
                Today, I focus on building simple, intuitive experiences across fintech, edtech, and ecommerce. I care about making products easy to use, visually clear, and actually useful in real life.
              </p>
            </div>
        ...
        <section className="container-custom mb-32 section-dark py-24 border-y border-card-border">
          <div className="text-center max-w-3xl mx-auto mb-16 scroll-reveal">
            ...
            <p className="text-lg text-text-secondary leading-relaxed">
              Design is more than visuals. It is about solving problems clearly and effectively while aligning with business goals.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "User First", desc: "Understanding the human behind the screen to build natural, empathetic flows.", icon: <Users size={32} /> },
              { title: "Simplify Complexity", desc: "Turning complicated systems into clear, actionable, and minimal interfaces.", icon: <Zap size={32} /> },
              { title: "Business Aligned", desc: "Designing experiences that not only look good but drive conversion and growth.", icon: <Target size={32} /> }
            ].map((card, idx) => (
          ...
          <div className="relative overflow-hidden bg-accent border border-accent/20 rounded-[40px] p-12 md:p-20 text-center shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="text-lg md:text-xl text-white/80 font-medium mb-12 max-w-2xl mx-auto">
                For a comprehensive breakdown of my work history, process, and past projects, grab a copy of my CV.
              </p>
              <a 
                href="/cv.pdf" 
                download
