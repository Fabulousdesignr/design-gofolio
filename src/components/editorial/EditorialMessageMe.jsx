...
export default function EditorialMessageMe() {
  ...
  const contactMethods = [
    {
      title: "Email Me",
      description: "For formal inquiries, project details, and long-form discussions.",
    ...
    },
    {
      ...
      action: "https://wa.me/2348123456789", // Placeholder WhatsApp link
      actionText: "Start a chat"
    },
    {
      title: "Book a Call",
      description: "Schedule a 30-minute discovery call to discuss your product needs.",
      icon: <Calendar size={24} className="text-text-primary" />,
      action: "https://calendly.com", // Placeholder Calendly link
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-20 relative z-10">
        ...
        <div className="w-full lg:w-[45%] flex flex-col">
          ...
          <p className="text-text-secondary text-[20px] md:text-[22px] leading-[1.5] mb-12 max-w-lg font-medium">
            If you are building something ambitious and need a product designer who thinks in systems, execution, and outcomes, let’s talk.
          </p>

          <div className="prose prose-lg text-text-secondary">
            <p className="mb-6 leading-[1.7]">
              I work with startups, founders, and teams building meaningful products across AI, SaaS, fintech, and digital platforms.
            </p>
            <p className="leading-[1.7]">
              Whether you need product strategy, UX direction, rapid prototyping, or design execution, I’m always open to thoughtful conversations and exciting ideas.
            </p>
          </div>
        </div>
